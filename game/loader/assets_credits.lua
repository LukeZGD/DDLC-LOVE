function loaderCredits(c_timer)
	...
	elseif c_timer >= 75 and c_timer < 84 then
		nats1 = nil
		if not yuri1 then yuri1 = lg.newImage('assets/images/cg/credits/3.png') end
	elseif c_timer >= 86 and c_timer < 93 then
		nats2 = nil
		if not yuri2 then yuri2 = lg.newImage('assets/images/cg/credits/4.png') end
	...
	elseif c_timer >= 130 and c_timer < 138 then
		sayo1 = nil
		if not m_sticker_1 then m_sticker_1 = lg.newImage('assets/images/gui/poemgame/m_sticker_1.png') end
		if not n_sticker_1 then n_sticker_1 = lg.newImage('assets/images/gui/poemgame/n_sticker_1.png') end
		if not s_sticker_1 then s_sticker_1 = lg.newImage('assets/images/gui/poemgame/s_sticker_1.png') end
		if not y_sticker_1 then y_sticker_1 = lg.newImage('assets/images/gui/poemgame/y_sticker_1.png') end
	...
	elseif c_timer >= 145 and c_timer < 164 then
		...
		s_sticker_1 = nil
		y_sticker_1 = nil
		if not moni1 then moni1 = lg.newImage('assets/images/cg/credits/10.png') end
	elseif c_timer >= 164 then
		sayo3 = nil
		moni1 = nil
		if not splashw then splashw = lg.newImage('assets/images/cg/credits/splashw.png') end
	end
end
