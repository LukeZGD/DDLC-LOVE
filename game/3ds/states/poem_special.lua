...
function poem_special_i(poem)
	...
	poemsp.bottomX = 0
	if p_number == 1 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_special1.png')
		poemsp.topX = 40
	elseif p_number == 4 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_special4.png')
		poemsp.bottomimg = lgnewImage('assets/images/poem_special/poem_special4-2.png')
	elseif p_number == 7 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_special7a.png')
		poemsp.topX = 120
	elseif p_number == 9 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_special9.png')
		poemsp.bottomimg = lgnewImage('assets/images/poem_special/poem_special9-2.png')
		poemsp.bottomX = -10
	elseif p_number == 11 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_special11.png')
		poemsp.bottomimg = lgnewImage('assets/images/poem_special/poem_special11-2.png')
		poemsp.bottomX = -10
	elseif p_number == 12 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_end.png')
		poemsp.topX = 40
	elseif p_number == 13 then
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_end_clearall1.png')
		poemsp.bottomimg = lgnewImage('assets/images/poem_special/poem_end_clearall2.png')
		poemsp.topX = 40
	else
		poemsp.topimg = lgnewImage('assets/images/poem_special/poem_special'..p_number..'.png')
	end
	state = 'poem_special'
	xaload = 0
	sfxplay('pageflip')
